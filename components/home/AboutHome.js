          ...
          <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1.5fr)_minmax(0,0.8fr)] lg:gap-12">
            ...
            <Reveal>
              ...
              <div className="mt-6 max-w-[650px] space-y-4 text-[15px] leading-7 text-zinc-400">
                <p>
                  I am a Software Engineering student at SMK Taruna Bhakti with an interest
                  in web development and UI/UX design. I enjoy building responsive,
                  user-friendly websites while continuously learning new technologies.
                </p>
                <p>
                  Through school projects, personal projects, and self-learning, I continue
                  to develop my technical skills and explore modern web development.
                </p>
              </div>
            </Reveal>
          ...
          <div className="mt-8 flex flex-col gap-4 rounded-2xl border border-white/10 bg-white/[0.02] p-6 sm:flex-row sm:items-start sm:p-8">
            ...
            <div>
              ...
              <p className="mt-3 max-w-[560px] text-[14px] leading-7 text-zinc-400">
                Di SMK Taruna Bhakti, saya mempelajari dasar-dasar pengembangan perangkat
                lunak dan membangun fondasi untuk berkembang sebagai Software Engineer.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid items-end gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,280px)]">
            <Reveal>
              ...
              <p className="mt-5 max-w-[650px] text-[15px] leading-8 text-zinc-400">
                Saya ingin terus berkembang sebagai Software Engineer melalui project yang
                semakin kompleks, memahami masalah dari sisi pengguna, dan secara bertahap
                mengeksplorasi AI engineering sebagai bagian dari perjalanan belajar saya.
              </p>
            </Reveal>
